...
package body counter_register_record_pkg is
  ...
  function to_slv(data : counter_command_t) return register_t is
    variable result : register_t := (others => '-');
  begin
    result(counter_command_reset_counter) := data.reset_counter;
  ...
  begin
    result.reset_counter := data(counter_command_reset_counter);
  ...
  begin
    ...
    result(counter_status_pulse_count) := std_ulogic_vector(data.pulse_count);
  ...
  begin
    ...
    result.pulse_count := counter_status_pulse_count_t(data(counter_status_pulse_count));
